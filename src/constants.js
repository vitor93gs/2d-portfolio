...
export const dialogueData = {
  ...
  degree:
    "Framed and proudly displayed, my degree in Electrical Engineering is a testament to years of hard work and late-night study sessions. I will eventually hang beside it my certificates from bootcamps in Data Science and Web Development. I'm currently pursuing a postgrad course in AI, and soon, that certificate will join the collection.",

  bookcase:
    "Books upon books, a world of adventures and knowledge. Among the coding classics like 'Clean Code,' you might also find books in Portuguese, French, and a bit of Spanish and German (some of the languages I speak). Always something new to learn!",
